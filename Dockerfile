...
RUN git lfs install
RUN git clone https://github.com/allthingssecurity/sample pocketsphinx && cd pocketsphinx && cmake --build build --target install
...
COPY o2.jpg /content/o2.jpg
COPY obama2.wav /content/obama2.wav
COPY trump.wav /content/trump.wav
COPY khujli.jpg /content/khujli.jpg
